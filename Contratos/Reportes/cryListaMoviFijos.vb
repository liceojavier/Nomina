...
Public Class cryListaMoviFijos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cryListaMoviFijos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_fechaMostrar() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcryListaMoviFijos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryListaMoviFijos = New cryListaMoviFijos()
        rpt.Site = Me.Site
        Return rpt
    End Function
