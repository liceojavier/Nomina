...
Public Class cyrImpReportes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cyrImpReportes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcyrImpReportes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cyrImpReportes = New cyrImpReportes()
        rpt.Site = Me.Site
        Return rpt
    End Function
