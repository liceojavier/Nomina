...
Public Class MovCtaCorriente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.MovCtaCorriente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMovCtaCorriente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MovCtaCorriente = New MovCtaCorriente()
        rpt.Site = Me.Site
        Return rpt
    End Function
