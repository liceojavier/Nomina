...
Public Class frmListadoEvaluacionDoc2015
    ...
    Private Sub llenaTipoTest(ByVal ciclo As String)
        ...
        If Not (String.IsNullOrEmpty(ciclo)) Then
            Dim cdata2 As New cmodelo(_conexionAcademia)
            cadena = "select tipotest,nombre as nombre from evaluatipotest where ciclo=" & ciclo & " order by tipotest"
            cdata2.llenaTabla(cadena, tbTipotest)
            cdata2.Commit()
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        Try
            ...
            If (rbPreguntaSecc.Checked) Then
                ...
                "FROM " & _
                "( " & _
                "select ev1.ciclo, ev1.tipotest, ct.nombre as nombretest, " & _
                ...
                "and evc1.codigo=ev1.codigo and evc1.tipotest=ev1.tipotest and evc2.numpregunta=cp.numpregunta and evc2.numopcion=cop.numopcion) as cuenta, " & _
                " ar.nombre as nombre_area, cp.grupo_respuesta " & _
                ...
                "ma.apell1, ma.apell2, ar.nombre, ct.nombre, ev1.seccion, cp.grupo_respuesta " & _
                ") " & _
            ...
            ElseIf (rbPreguntaGra.Checked) Then
                ...
                "group by ev1.ciclo,  ev1.tipotest, ev1.colegio, ev1.nivel, ev1.grado, ev1.codigo, " & _
                "cp.numpregunta, cop.numopcion, cp.pregunta, cop.opcion, co.nombre, ni.nombre, gr.nombre, ma.nom1, ma.nom2, " & _
                "ma.apell1, ma.apell2, ar.nombre, ct.nombre, cp.grupo_respuesta " & _
                ") " & _
                "LL order by colegio,nivel,grado, nombre, tipotest, numpregunta, numopcion"
            ...
            ElseIf (rbPreguntasNivel.Checked) Then
                ...
                "ma.apell1, ma.apell2, ar.nombre, ct.nombre, ni.nombre, cp.grupo_respuesta" & _
                ") " & _
            ...
            If tabla.Rows.Count > 0 Then
                If rbPreguntaSecc.Checked Then
                    r = New listadoevaluacionesmaestros2015
                ElseIf rbPreguntaGra.Checked Then
                    r = New listadoevaluacionesmaestros_grados2015
                ElseIf rbPreguntasNivel.Checked Then
                    r = New listadoevaluacionesmaestros_nivel2015
                End If
