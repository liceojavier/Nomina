...
Public Class Grafica2022xnivel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.Grafica2022xnivel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGrafica2022xnivel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Grafica2022xnivel = New Grafica2022xnivel()
        rpt.Site = Me.Site
        Return rpt
    End Function
