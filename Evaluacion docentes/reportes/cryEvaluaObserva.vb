...
Public Class cryEvaluaObserva
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cryEvaluaObserva.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryEvaluaObserva
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryEvaluaObserva = New cryEvaluaObserva()
        rpt.Site = Me.Site
        Return rpt
    End Function
