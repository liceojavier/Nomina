...
Public Class tabla_grafico2022
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.tabla_grafico2022.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedtabla_grafico2022
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As tabla_grafico2022 = New tabla_grafico2022()
        rpt.Site = Me.Site
        Return rpt
    End Function
