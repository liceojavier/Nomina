...
Public Class Grafica2022xgrado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.Grafica2022xgrado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGrafica2022xgrado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Grafica2022xgrado = New Grafica2022xgrado()
        rpt.Site = Me.Site
        Return rpt
    End Function
