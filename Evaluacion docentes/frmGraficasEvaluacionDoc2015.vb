...
Public Class frmGraficasEvaluacionDoc2015
...
#End Region
    ...
    Private Sub llenaTipoTest(ByVal ciclo As String)
        ...
        If Not (String.IsNullOrEmpty(ciclo)) Then
            cadena = "select tipotest,nombre from evaluatipotest where ciclo=" & txtCiclo.Text
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        Try
            ...
            If (rbPreguntasNi.Checked) Then
                cadena = "select LL.* FROM ( select ev1.ciclo, ev1.tipotest, ct.nombre as nombretest, ev1.colegio, co.nombre as nomb_colegio, " & _
                        ...
                        "inner join evaluaopciones cop on cop.ciclo=ev1.ciclo and cop.tipotest=ev1.tipotest and cop.numpregunta=cp.numpregunta " & _
                        ...
                        "cop.opcion, co.nombre, ni.nombre,  ct.nombre ) LL " & _
            ...
            ElseIf (rbPreguntasGr.Checked) Then
                cadena = "select LL.* FROM ( select ev1.ciclo, ev1.tipotest, ct.nombre as nombretest, ev1.colegio, co.nombre as nomb_colegio, " & _
                         ...
                         "cop.opcion, co.nombre, ni.nombre, gr.nombre,  ct.nombre ) LL " & _
                         "order by colegio,numpregunta,numopcion "
            ElseIf (rbDocenteEvaluado.Checked) Then
                ...
                cadena = "select LL.*  FROM  (  select ev1.ciclo, ev1.tipotest, ct.nombre as nombretest,  ev1.colegio, co.nombre as nomb_colegio,  ev1.nivel, " & _
                         ...
                         "inner join evadoctest2 evc2 on evc1.ciclo=evc2.ciclo and evc1.numtest=evc2.numtest  " & _
                         "inner join evaluapreguntas ecp on evc1.ciclo=ecp.ciclo and ecp.tipotest=evc1.tipotest and ecp.numpregunta=evc2.numpregunta " & _
                         ...
                         "inner join grados  gr on gr.colegio=ev1.colegio and gr.nivel=ev1.nivel and gr.grado=ev1.grado  " & _
                         "inner join evaluapreguntas cp on cp.ciclo=ev1.ciclo and cp.tipotest=ev1.tipotest " & _
                         "inner join evalua_areas ca on cp.area=ca.area  and ct.ciclo=ca.ciclo " & _
                         "inner join evaluaopciones cop on cop.ciclo=ev1.ciclo and cop.tipotest=ev1.tipotest and cop.numpregunta=cp.numpregunta " & _
                         "inner join maestros ma on ma.codigo=ev1.codigo " & _
                         "inner join areas ar on ma.area=ar.area " & _
                         "left join evadoctest2 ev2 on ev1.ciclo=ev2.ciclo and ev1.numtest=ev2.numtest and cp.numpregunta = ev2.numpregunta " & _
                         ...
                         "gr.nombre, ma.nom1, ma.nom2, ma.apell1, ma.apell2, ar.nombre, ct.nombre ) LL order by colegio,nivel,grado, nombre, numcompe,numopcion "
            ...
            ElseIf (rbCompeNivel.Checked) Then
                ...
                cadena = "select LL.*  FROM  (  select ev1.ciclo, ev1.tipotest, ct.nombre as nombretest,  ev1.colegio, co.nombre as nomb_colegio," & _
                         ...
                         "cop.numopcion, cop.opcion, co.nombre, ca.area, ca.nombre, ni.nombre, " & _
                         "ct.nombre ) LL order by colegio,nivel, compe, numopcion "
            ElseIf rbCompeGrado.Checked Then
                ...
                cadena = "select LL.*  FROM  (  select ev1.ciclo, ev1.tipotest, ct.nombre as nombretest,  ev1.colegio, co.nombre as nomb_colegio," & _
                         ...
                         "cop.numopcion, cop.opcion, co.nombre, ca.area, ca.nombre, ni.nombre, " & _
                         "gr.nombre, ct.nombre ) LL order by colegio,nivel,grado, compe, numopcion "
            ElseIf rbCompTipEvaArea.Checked Then
                ...
                cadena = " select ev1.ciclo,ev1.colegio,ev1.tipotest,ca.area as compe,ca.nombre as nomcompe," & _
                         ...
                         " (select count(*) from evadoctest1 evc1 " & _
                         " inner join evadoctest2 evc2 on evc1.ciclo=evc2.ciclo and evc1.numtest=evc2.numtest " & _
                         " inner join evaluapreguntas cp on cp.numpregunta=evc2.numpregunta and cp.ciclo=evc1.ciclo and cp.tipotest=evc1.tipotest  " & _
                         " inner join evalua_areas ca1 on ca1.area=cp.area and evc1.ciclo=ca1.ciclo  " & _
                         ...
                         " inner join evaluapreguntas c on ev1.ciclo=c.ciclo and ev1.tipotest=c.tipotest and b.numpregunta=c.numpregunta " & _
                         " inner join evaluaopciones d on ev1.ciclo=d.ciclo and ev1.tipotest=d.tipotest and b.numpregunta=d.numpregunta  " & _
                         " inner join evalua_areas ca on c.area=ca.area and ev1.ciclo=ca.ciclo " & _
