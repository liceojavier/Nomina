...
Public Class cryListadoCEviados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cryListadoCEviados.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_nomina() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcryListadoCEviados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryListadoCEviados = New cryListadoCEviados()
        rpt.Site = Me.Site
        Return rpt
    End Function
