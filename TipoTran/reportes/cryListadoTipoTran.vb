...
Public Class cryListadoTipoTran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cryListadoTipoTran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryListadoTipoTran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryListadoTipoTran = New cryListadoTipoTran()
        rpt.Site = Me.Site
        Return rpt
    End Function
