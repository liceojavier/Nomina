...
'*************************************************************************************************
'*************************************************************************************************
'**  FORMULARIO:    FRMMUESTRA2COLUMNAS.VB MIEMBRO DE NOMINA.SLN                                **
'**  AUTOR:         IVAN TRUJILLO                                                               **
'**  FECHA:         01/01/2008                                                                  **
'**  FECHA DE MOD:  --/--/----                                                                  **
'**  DESCRIPCION:                                                                               **
...
Public Class frmMuestra2Columnas
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmMuestra2Columnas))
...
#End Region
    ...
    Public Sub inicializa(ByRef tabla As DataTable, ByVal nom1Arg As String, ByVal nom2Arg As String, ByVal numColuArg As Integer)
        cuent = tabla
        nomb1 = nom1Arg
        nomb2 = nom2Arg
    ...
    Private Sub dgCuentas_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dgCuentas.DoubleClick
        If dgCuentas.SelectedRows.Count > 0 Then
            _fila = CType(dgCuentas.SelectedRows(0).DataBoundItem, DataRowView).Row
            regresar()
        Else
