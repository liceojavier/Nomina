...
Public Class cryLibroSalario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cryLibroSalario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryLibroSalario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryLibroSalario = New cryLibroSalario()
        rpt.Site = Me.Site
        Return rpt
    End Function
