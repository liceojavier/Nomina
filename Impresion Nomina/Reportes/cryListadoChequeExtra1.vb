...
Public Class cryListadoChequeExtra1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cryListadoChequeExtra1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cryListadoChequeExtra1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryListadoChequeExtra1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryListadoChequeExtra1 = New cryListadoChequeExtra1()
        rpt.Site = Me.Site
        Return rpt
    End Function
