...
Public Class cryLibroSalario20017
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cryLibroSalario20017.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cryLibroSalario20017.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryLibroSalario20017
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryLibroSalario20017 = New cryLibroSalario20017()
        rpt.Site = Me.Site
        Return rpt
    End Function
