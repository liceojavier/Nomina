...
Public Class cryListadoNominaG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cryListadoNominaG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryListadoNominaG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryListadoNominaG = New cryListadoNominaG()
        rpt.Site = Me.Site
        Return rpt
    End Function
