...
Public Class cryListadoDevengado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cryListadoDevengado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cryListadoDevengado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryListadoDevengado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryListadoDevengado = New cryListadoDevengado()
        rpt.Site = Me.Site
        Return rpt
    End Function
