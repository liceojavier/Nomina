...
Public Class consulta_jefes_sub
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.consulta_jefes_sub.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedconsulta_jefes_sub
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As consulta_jefes_sub = New consulta_jefes_sub()
        rpt.Site = Me.Site
        Return rpt
    End Function
