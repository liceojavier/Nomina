...
Public Class frmResultadoEvaluaciones
...
#End Region
    ...
    Private Sub frmResultadoEvaluaciones_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cadena = " select a.nombre,a.tipotest from evaluatipotest a where ciclo=@ciclo order by tipotest"
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        If rbCompetencias.Checked = True Then
            If validetError(TextCiclo, ep1) Then
                If tipoevaluador = "1" Then
                    v = New Cryconsultaporcompetencias
                Else
                    v = New Cryconsultaporcompetenciasxevaluador
                End If
                ...
                Else
                    cadena = cadena & ",''"
                End If
                If TextEmpleado2.Text <> "" Then
                    cadena = cadena & "," & TextEmpleado2.Text
                Else
                    cadena = cadena & ",''"
        ...
        ElseIf rbHabilidades.Checked = True Then
            ...
            If tipoevaluador = "1" Then
                v = New Cryconsultaporhabilidades
            Else
                v = New Cryconsultaporhabilidadesxevaluador
            End If

        If validetError(TextCiclo, ep1) Then
                If cmbtipotest.Text <> "" Then

                    cadena = "exec proc_nomi_consultaxhabilidades @ciclo,@empresa,@tipotest "
                Else
                    cadena = "exec proc_nomi_consultaxhabilidades @ciclo,@empresa,''"
                End If
        ...
        Dim v As New Cryconsultapordestreza
        If validetError(cmbtipotest, ep1) And validetError(TextCiclo, ep1) Then
            If cmbtipotest.Text <> "" Then
                    cadena = "exec proc_nomi_consultaxdestreza @ciclo,@empresa,@tipotest"
                Else
                    cadena = "exec proc_nomi_consultaxdestreza @ciclo,@empresa,''"
            ...
            Try
                If llenaTabla(cadena, tt) > 0 Then
                        ...
                        'v.SetDatabaseLogon(usuario, password, servidor, baseDatos)
                    v.SetDataSource(tt)
                    If cmbtipotest.Text.Trim <> "" Then
                        v.SetParameterValue("tipotest", tbtipotest.Rows(cmbtipotest.SelectedIndex).Item("nombre"))
                    Else
        ...
        Dim v As New CryconsultaPorcentajes
        ...
        Dim cantidadmuestra As Integer
            ...
            If cmbtipotest.Text <> "" Then
                    cadena = "exec proc_nomi_consultaxporcentaje @ciclo,@empresa,@tipotest"

                    cadenamuestra = cadenamuestra & " and a.tipotest =@tipotest"
                Else
                    cadena = "exec proc_nomi_consultaxporcentaje @ciclo,@empresa,''"
                End If

            If cmbTipoEmpleado.Text <> "" Then
                cadena = cadena & "," & tbTipoEmpleado.Rows(cmbTipoEmpleado.SelectedIndex).Item("tipoempleado")
                cadenamuestra = cadenamuestra & " and b.tipoempleado=" & tbTipoEmpleado.Rows(cmbTipoEmpleado.SelectedIndex).Item("tipoempleado")
            Else
                cadena = cadena & ",''"
