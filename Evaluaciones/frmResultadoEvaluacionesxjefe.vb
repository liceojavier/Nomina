...
'*************************************************************************************************
'*************************************************************************************************
'**  FORMULARIO:    FRMRESULTADOEVALUACIONESXJEFE.VB MIEMBRO DE NOMINA.SLN                      **
'**  AUTOR:         IVAN TRUJILLO                                                               **
'**  FECHA:         01/01/2008                                                                  **
'**  FECHA DE MOD:  --/--/----                                                                  **
'**  DESCRIPCION:                                                                               **
...
Public Class frmResultadoEvaluacionesxjefe
    ...
    Dim v As New Cryconsultaporcompetencias
...
#Region "EMPLEADO"
    ...
    Private Sub btnEmpleadoNomb_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEmpleado.Click
        ...
        cadena = "select empleado,nombre from v_empleadosnuevo where nombre like '%' + @nombre + '%' and empresa =@empresa " &
                " and empleado in (select jefe from contratosjefes  where jefe<>0 group by jefe having count(empleado)>0) order by nombre"
...
#Region "EMPLEADO2"
    ...
    Private Sub btnEmpleado2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim numFilas As Int32

        '  cadena = "select empleado,nombre from v_empleadosnuevo where nombre like '%" & TextNombreEmple2.Text.Trim & "%' and empresa =" & empresa & _
        '        " and empleado in (select jefe from contratosjefes  where jefe<>0 group by jefe having count(empleado)>0) order by nombre"
    ...
    Private Sub ValidaEmpleado2()
        ...
        '" and empleado=" & TextEmpleado2.Text.Trim) = 0 Then
        MsgBox("CODIGO DEL EMPLEADO NO EXISTE, VERIFIQUE", MsgBoxStyle.Information, "Mensaje del Sistema")
        BorraEmpleado2(True)
        'TextEmpleado2.Focus()
        Exit Sub
        ...
        '" and empleado=" & TextEmpleado2.Text.Trim & " " & _
    ...
    Private Sub TextEmpleado_Validated2(ByVal sender As Object, ByVal e As System.EventArgs)
...
#End Region
    ...
    Private Sub frmResultadoEvaluaciones_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cadena = " select a.nombre,a.tipotest from evaluatipotest a order by tipotest"
        llenaTabla(cadena, tbtipotest)
        llena_combo(cadena, cmbtipotest)
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        If rbCompetencias.Checked = True Then
            If validetError(TextCiclo, ep1) Then
                Dim v As New Cryconsultaporcompetenciasxjefes
                If cmbtipotest.Text <> "" Then
                    lpara("tipotest") = tbtipotest.Rows(cmbtipotest.SelectedIndex).Item("tipotest")
                    cadena = "exec proc_nomi_consultaxcompetenciasxjefes @ciclo,@empresa,tipotest "
                Else
                    cadena = "exec proc_nomi_consultaxcompetenciasxjefes @ciclo,@empresa, '' "
                End If
                If cmbTipoEmpleado.Text <> "" Then
                    cadena = cadena & "," & tbTipoEmpleado.Rows(cmbTipoEmpleado.SelectedIndex).Item("tipoempleado")
                Else
                    cadena = cadena & ",''"
                End If
                If textEmpleado.Text <> "" Then
                    cadena = cadena & "," & textEmpleado.Text
                Else
                    cadena = cadena & ",''"
                End If
                If TextPuesto.Text <> "" Then
                    cadena = cadena & "," & TextPuesto.Text
                Else
                    cadena = cadena & ",''"
                End If
                ...
                Try
                    If llenaTabla(cadena, tt, ListaParametros(lpara)) > 0 Then
                        ...
                        End If
                        If textNombreEmple.Text <> "" Then
                            v.SetParameterValue("nomEvaluador", textNombreEmple.Text)
                        Else
                            v.SetParameterValue("nomEvaluador", "")
                        End If
                ...
                End Try
            End If
        ElseIf rbHabilidades.Checked = True Then
            Dim v As New Cryconsultaporhabilidadesxjefes

            If validetError(TextCiclo, ep1) Then
                If cmbtipotest.Text <> "" Then
                    lpara("tipotest") = tbtipotest.Rows(cmbtipotest.SelectedIndex).Item("tipotest")
                    cadena = "exec proc_nomi_consultaxhabilidadesxjefes @ciclo,@empresa,@tipotest "
                Else
                    cadena = "exec proc_nomi_consultaxhabilidadesxjefes @ciclo,@empresa,''"
                End If
        ...
        ElseIf rbDestreza.Checked = True Then
            Dim v As New Cryconsultapordestrezaxjefes
            'If validetError(cmbtipotest, ep1) And validetError(TextCiclo, ep1) Then
            If cmbtipotest.Text <> "" Then
                lpara("tipotest") = tbtipotest.Rows(cmbtipotest.SelectedIndex).Item("tipotest")
                cadena = "exec proc_nomi_consultaxdestrezaxjefes @ciclo,@empresa,@tipotest "
            Else
                cadena = "exec proc_nomi_consultaxdestrezaxjefes @ciclo,@empresa,''"
        ...
        ElseIf rbPorcentaje.Checked = True Then
            Dim v As New CryconsultaPorcentajesxjefes
            ...
            If validetError(cmbtipotest, ep1) And validetError(TextCiclo, ep1) Then
                ...
                If cmbtipotest.Text <> "" Then
                    lpara("tipotest") = tbtipotest.Rows(cmbtipotest.SelectedIndex).Item("tipotest")
                    cadena = "exec proc_nomi_consultaxporcentajexjefes @ciclo,@empresa,@tipotest "
                    cadenamuestra = cadenamuestra & " and a.tipotest =@tipotest "
                Else
                    cadena = "exec proc_nomi_consultaxporcentajexjefes @ciclo,@empresa,''"
                End If

                If cmbTipoEmpleado.Text <> "" Then
                    lpara("tipoEmpleado") = tbTipoEmpleado.Rows(cmbTipoEmpleado.SelectedIndex).Item("tipoempleado")
                    cadena = cadena & "," & tbTipoEmpleado.Rows(cmbTipoEmpleado.SelectedIndex).Item("tipoempleado")
                    cadenamuestra = cadenamuestra & " and b.tipoempleado=@tipoEmpleado "
                Else
                    cadena = cadena & ",''"
                ...
                If textEmpleado.Text <> "" Then
                    ...
                    cadena = cadena & "," & textEmpleado.Text
                    cadenamuestra = cadenamuestra & " and a.empleado=@empleado "
                Else
                    cadena = cadena & ",''"
                End If
                ...
                If TextPuesto.Text <> "" Then
                    ...
                    cadena = cadena & "," & TextPuesto.Text
                    cadenamuestra = cadenamuestra & " and b.puesto=@puesto "
                Else
                    cadena = cadena & ",''"
                End If
    ...
    rbPorcentaje.CheckedChanged, rbCompetencias.CheckedChanged, rbDestreza.CheckedChanged, rbHabilidades.CheckedChanged
        If rbCompetencias.Checked Then
            gpEvaluado.Visible = True
            gpPuesto.Visible = True
            gpTipo.Visible = True
        ElseIf rbHabilidades.Checked Then
            gpEvaluado.Visible = True
            gpPuesto.Visible = True
            gpTipo.Visible = True
