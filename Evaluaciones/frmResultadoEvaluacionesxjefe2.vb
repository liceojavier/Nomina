...
Public Class frmResultadoEvaluacionesxjefe2
...
#End Region
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        If rbCompetencias.Checked = True Then
            If validetError(TextCiclo, ep1) Then
                ...
                If cmbtipotest.Text <> "" Then
                    ...
                    cadena = "exec proc_nomi_consultaxcompetenciasxjefes2 @ciclo,@empresa,@tipotest "
                Else
                    cadena = "exec proc_nomi_consultaxcompetenciasxjefes2 @ciclo,@empresa,''"
                End If
        ...
        ElseIf rbDestreza.Checked = True Then
            ...
            If cmbtipotest.Text <> "" Then
                lpara("tipotest") = tbtipotest.Rows(cmbtipotest.SelectedIndex).Item("tipotest")
                cadena = "exec proc_nomi_consultaxdestrezaxjefes2 @ciclo,@empresa,@tipotest "
            Else
                cadena = "exec proc_nomi_consultaxdestrezaxjefes2 @ciclo,@empresa,'' "
            End If
        ...
        ElseIf rbPorcentaje.Checked = True Then
            ...
            If validetError(cmbtipotest, ep1) And validetError(TextCiclo, ep1) Then
                ...
                If cmbtipotest.Text <> "" Then
                    lpara("tipotest") = tbtipotest.Rows(cmbtipotest.SelectedIndex).Item("tipotest")
                    cadena = "exec proc_nomi_consultaxporcentajexjefes2 @ciclo,@empresa,@tipotest "

                    cadenamuestra = cadenamuestra & " and a.tipotest =@tipotest "
                Else
                    cadena = "exec proc_nomi_consultaxporcentajexjefes2 @ciclo,@empresa,''"
                End If
    ...
    rbPorcentaje.CheckedChanged, rbCompetencias.CheckedChanged, rbDestreza.CheckedChanged
