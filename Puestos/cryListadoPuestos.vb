...
Public Class cryListadoPuestos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cryListadoPuestos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryListadoPuestos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryListadoPuestos = New cryListadoPuestos()
        rpt.Site = Me.Site
        Return rpt
    End Function
