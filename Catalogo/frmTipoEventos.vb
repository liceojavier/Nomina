...
Public Class frmTipoEventos
    ...
    Private Sub frmTipoEventos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnLimpiar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLimpiar.Click
        ...
        cadena = "SELECT tipoevento, nombre " &
                 "FROM tiposeventos order by tipoevento "
    ...
    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        ...
        If validetError(TextNombre, ep1) = False Then
            Exit Sub
        End If
        lpara("tipoEvento") = textnum.Text
        lpara("nombre") = TextNombre.Text
        Select Case accion
            Case 0
                cadena = "insert tiposeventos(tipoevento,nombre) values(@tipoEvento,@nombre)"
            Case 1
                cadena = "update tiposeventos set nombre=@nombre where tipoevento=@tipoEvento"
        End Select
    ...
    Private Sub mnuAgrega_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ctxAgregar.Click
        ...
        textnum.Text = BuscaEscalar("select coalesce ( max(tipoevento), 0) from tiposeventos ") + 1
        TextNombre.Focus()
    End Sub
    ...
    Private Sub MnuElimina_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ctxEliminar.Click
        ...
        If dgDatos.SelectedRows.Count > 0 Then
            ...
            lpara("tipoEvento") = filaTemp.Item(0)
            If MsgBox("ESTA SEGURO DE ELIMINAR EL REGISTRO MARCADO", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Mensaje del Sistema") = MsgBoxResult.Yes Then
                If BuscaEscalar("select count(*) from eventosper where tipoevento=@tipoEvento", ListaParametros(lpara)) > 0 Then
                    MsgBox("REGISTRO POSEE REFERENCIA", MsgBoxStyle.Critical, "Mensaje del Sistema")
                    Exit Sub
                End If
                'verificar si tiene referencia en inscripciones
                cadena = "delete from tiposeventos where tipoevento=@tipoEvento"
                EjecutarQuery(cadena, ListaParametros(lpara))
