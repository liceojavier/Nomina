...
Public Class cryListadoSueldos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cryListadoSueldos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryListadoSueldos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryListadoSueldos = New cryListadoSueldos()
        rpt.Site = Me.Site
        Return rpt
    End Function
