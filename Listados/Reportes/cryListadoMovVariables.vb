...
Public Class cryListadoMovVariables
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cryListadoMovVariables.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NOMINA.cryListadoMovVariables.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryListadoMovVariables
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryListadoMovVariables = New cryListadoMovVariables()
        rpt.Site = Me.Site
        Return rpt
    End Function
