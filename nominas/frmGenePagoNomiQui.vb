...
'*************************************************************************************************
'*************************************************************************************************
'**  FORMULARIO:    FRMGENEPAGONOMIQUI.VB MIEMBRO DE NOMINA.SLN                                 **
'**  AUTOR:         IVAN TRUJILLO                                                               **
'**  FECHA:         01/01/2008                                                                  **
'**  FECHA DE MOD:  --/--/----                                                                  **
'**  DESCRIPCION:                                                                               **
...
Public Class frmGenePagoNomiQui
    Inherits Form
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmGenePagoNomiQui))
        ...
        Me.gpFecha.Location = New System.Drawing.Point(13, 61)
        Me.gpFecha.Name = "gpFecha"
        Me.gpFecha.Size = New System.Drawing.Size(811, 75)
        ...
        Me.rbSeleccion.Location = New System.Drawing.Point(649, 41)
        ...
        Me.rbTodos.Location = New System.Drawing.Point(649, 18)
        ...
        Me.btnLimpiar.Location = New System.Drawing.Point(549, 41)
        ...
        Me.Label4.Location = New System.Drawing.Point(452, 22)
        ...
        Me.cmbTipo.Location = New System.Drawing.Point(80, 19)
        ...
        Me.TextAño.Location = New System.Drawing.Point(487, 19)
        ...
        Me.btnEjecutar.Location = New System.Drawing.Point(549, 10)
        ...
        Me.cmbMes.Location = New System.Drawing.Point(324, 19)
        ...
        Me.gpEmpresa.Location = New System.Drawing.Point(211, 1)
        ...
        Me.PgBar.Name = "PgBar"
        Me.PgBar.Size = New System.Drawing.Size(864, 23)
        ...
        Me.Panel1.Size = New System.Drawing.Size(877, 54)
        ...
        Me.Panel2.Size = New System.Drawing.Size(877, 38)
        ...
        Me.pnInfoEmpleado.Location = New System.Drawing.Point(13, 156)
        Me.pnInfoEmpleado.Name = "pnInfoEmpleado"
        Me.pnInfoEmpleado.Size = New System.Drawing.Size(811, 382)
        ...
        Me.btnGenerarArchivo.Location = New System.Drawing.Point(437, 321)
        ...
        Me.btnCargaArchivo.Location = New System.Drawing.Point(437, 350)
        ...
        Me.btnApli2.Location = New System.Drawing.Point(379, 350)
        ...
        Me.cklbTipoPersonal.Location = New System.Drawing.Point(185, 309)
        ...
        Me.textNoRegistros.Location = New System.Drawing.Point(654, 348)
        ...
        Me.Label1.Location = New System.Drawing.Point(576, 350)
        ...
        Me.btnDesel.Location = New System.Drawing.Point(95, 324)
        ...
        Me.btnSel.Location = New System.Drawing.Point(9, 324)
        ...
        Me.dgvEmpleado.Size = New System.Drawing.Size(769, 273)
        ...
        Me.ClientSize = New System.Drawing.Size(877, 591)
        ...
        Me.Name = "frmGenePagoNomiQui"
        Me.Text = "Generación de Nómina de Anticipo Quincenal"
...
#End Region
    ...
    Private Sub frmSaldos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cadena = "select nombre, tiponom, cantidad, por from tiponomina1 where empresa=@empresa and tiponom='A'"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEjecutar.Click
        ...
        Dim i, dias As Int32
        Dim cantidad, valorNom, por, cantidadI As Decimal
        Dim FechaInom, fechaFnom, fechaI As Date
        Dim transac, tipoNom As String
        Dim lpara As New Dictionary(Of String, Object)
        ...
        FechaInom = "01/" & cmbMes.SelectedIndex + 1 & "/" & año
        fechaFnom = cantidadI & "/" & cmbMes.SelectedIndex + 1 & "/" & año
        ...
        cadena = "select transacnom from tiponomina3 where empresa=@empresa and tiponom=@tiponom "
        transac = BuscaEscalar(cadena, ListaParametros(lpara))
        If transac = "" Then
            MsgBox("NO HAY TRANSACCION PARA GUARDAR ESTE TIPO DE NOMINA, VERIFIQUE", MsgBoxStyle.Exclamation, "Mensaje del Sistema")
            Exit Sub
        End If
        ...
        Try
            ...
            cadena = "select c1.contrato, c1.empleado,  c1.fechai, c1.tipoper, c1.tiposeguro, tip.tibase, c1.base , coalesce(tsus.nomina, 'X') as nomina, " &
                     " ( select coalesce( sum( valor),0) from sueldos su where su.empresa=c1.empresa and " &
                     "su.empleado=c1.empleado and su.contrato=c1.contrato and su.transac=1 ) as sueldo " &
                     "from contratos1 c1 " &
                     ...
                     "where tip.pagonomina='S' and c1.anticipo='S' and e.generapago='S' and c1.empresa=@empresa and c1.fechai < @fecha"
                    ...
                    If (filaTemp.Item("nomina") = "X" Or filaTemp.Item("nomina") = "S") And filaTemp.Item("sueldo") > 0 Then
                        ...
                        If filaTemp.Item("fechai") > fechaI Then
                            ...
                            ElseIf filaTemp.Item("tibase") = "H" Then
                                cantidad = (dias * filaTemp.Item("base") * 0.5) / 15
                            End If
            ...
            If modelo.Commit() Then
                InsertBitacora(9, 7, $"Generación nómina quincenal mes {mes} año {año}")
