...
'*************************************************************************************************
'*************************************************************************************************
'**  FORMULARIO:    FRMGENERAPAGO.VB MIEMBRO DE NOMINA.SLN                                      **
'**  AUTOR:         IVAN TRUJILLO                                                               **
'**  FECHA:         01/01/2008                                                                  **
'**  FECHA DE MOD:  --/--/----                                                                  **
'**  DESCRIPCION:                                                                               **
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmEliminaPago))
        ...
        Me.gpFecha.Location = New System.Drawing.Point(8, 128)
        Me.gpFecha.Name = "gpFecha"
        Me.gpFecha.Size = New System.Drawing.Size(964, 64)
        ...
        Me.dtpFecha.Location = New System.Drawing.Point(699, 25)
        ...
        Me.Label9.Location = New System.Drawing.Point(514, 29)
        ...
        Me.cmbTipo.Location = New System.Drawing.Point(93, 24)
        ...
        Me.TextAño.Location = New System.Drawing.Point(549, 25)
        ...
        Me.btnEjecutar.Location = New System.Drawing.Point(836, 19)
        Me.btnEjecutar.Name = "btnEjecutar"
        Me.btnEjecutar.Size = New System.Drawing.Size(80, 39)
        Me.btnEjecutar.TabIndex = 5
        Me.btnEjecutar.Text = "Eliminar pagos"
        Me.btnEjecutar.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        Me.ToolTip1.SetToolTip(Me.btnEjecutar, "Eliminar Pagos")
        ...
        Me.cmbMes.Location = New System.Drawing.Point(375, 24)
        ...
        Me.gpEmpresa.Location = New System.Drawing.Point(260, 6)
        Me.gpEmpresa.Name = "gpEmpresa"
        Me.gpEmpresa.Size = New System.Drawing.Size(456, 45)
        ...
        Me.stbPanel.Location = New System.Drawing.Point(0, 234)
        ...
        Me.ToolStripStatusLabel1.Text = "Realiza la generación de los medios de pago de la nómina del personal en calidad " &
    "de dependencia"
        ...
        Me.gpFormaPago.Location = New System.Drawing.Point(8, 62)
        Me.gpFormaPago.Name = "gpFormaPago"
        Me.gpFormaPago.Size = New System.Drawing.Size(964, 48)
        ...
        Me.Label11.Location = New System.Drawing.Point(811, 23)
        ...
        Me.TextChequeF.Location = New System.Drawing.Point(887, 19)
        ...
        Me.TextBanco.Location = New System.Drawing.Point(265, 19)
        ...
        Me.Label3.Location = New System.Drawing.Point(652, 23)
        ...
        Me.TextCheque.Location = New System.Drawing.Point(733, 20)
        ...
        Me.cmbFormaPago.Location = New System.Drawing.Point(6, 19)
        Me.cmbFormaPago.Name = "cmbFormaPago"
        Me.cmbFormaPago.Size = New System.Drawing.Size(179, 21)
        ...
        Me.TextNombBanco.Location = New System.Drawing.Point(382, 19)
        Me.TextNombBanco.MaxLength = 4
        Me.TextNombBanco.Name = "TextNombBanco"
        Me.TextNombBanco.ReadOnly = True
        Me.TextNombBanco.Size = New System.Drawing.Size(264, 20)
        ...
        Me.Panel1.Size = New System.Drawing.Size(979, 57)
        ...
        Me.Panel2.Size = New System.Drawing.Size(979, 40)
        ...
        Me.Name = "frmEliminaPago"
        Me.Text = "Eliminación de Pagos por Forma"
...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEjecutar.Click
        ...
        lpara("año") = año
        lpara("fpago") = fpago
        If MsgBox("ESTA SEGURO QUE DESEA ELIMINAR EL PAGO DE  ESTA NOMINA", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Mensaje del Sistema") = MsgBoxResult.Yes Then
            If "OK" = InputBox("INGRESE OK PARA CONFIRMAR LA ELIMINACION DEL PAGO DE NOMINA", "Mensaje del Sistema") Then

            End If
            cadena = "select count(*) from nominas where tiponom=@tiponom and mes=@mes and año=@año"
            If BuscaEscalar(cadena, ListaParametros(lpara)) = 0 Then
                ...
                Exit Sub
            End If
            cadena = "select count(*) from pagosnom where tiponom=@tiponom and mes=@mes and año=@año and fpago=@fpago "
            If BuscaEscalar(cadena, ListaParametros(lpara)) > 0 Then
                cadena = "select count(*) from pagosnom where tiponom=@tiponom and mes=@mes And año =@año And fpago = @fpago And estado <> 0"
                ...
                Try
                    If modelo.BuscaEscalar(cadena, ListaParametros(lpara)) = 0 Then
                        If MsgBox("YA EXISTEN REGISTROS GENERADOS, DESEA VOLVER A GENERAR EL PROCESO", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Mensaje del Sistema") = MsgBoxResult.No Then
                            Exit Sub
                        Else
                            cadena = "delete from pagosnom where tiponom=@tiponom and mes=@mes and año=@año and fpago=@fpago and estado = 0 "
                            ...
                            MsgBox("SI GENERO PAGOS CON CHEQUE, DEBE MODIFICAR EL CORRELATIVO MANUALMENTE ", MsgBoxStyle.Exclamation, "Mensaje del Sistema")
                        End If
                    Else
                        MsgBox("YA EXISTEN REGISTROS ANULADOS O TRASLADADOS A CONTABILIDAD", MsgBoxStyle.Information, "Mensaje del Sistema")
                        Exit Sub
                    End If
                    modelo.Commit()
